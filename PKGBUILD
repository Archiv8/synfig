...
pkgrel=1
# epoch=
pkgdesc="Open-source 2D Animation Software. Core package providing the CLI renderer"
arch=("x86_64")
url="https://www.synfig.org/"
license=("GPL2")
# groups=()
depends=("boost-libs" "cairo" "ffmpeg" "fftw" "fontconfig" "freetype2" "glibmm" "imagemagick" "libdv" "libmng" "libpng" "libsigc++" "libxml++2.6" "mlt" "ocl-icd" "openexr" "pango" "synfig-etl=1.3.14" "zlib")
# optdepends=()
makedepends=("boost" "git" "intltool" "opencl-headers")
# checkdepends=()
# provides=()
conflicts=("synfig")
replaces=("synfig")
...
prepare () {
  ...
  ./bootstrap.sh
#  --sysconfdir=/etc/synfig --prefix=/usr --enable-option-checking --disable-silent-rules --disable-static --enable-dependency-tracking --with-imagemagick --with-magickpp --with-ffmpeg --with-libdv --with-libavcodec --with-freetype --with-fontconfig --with-openexr --with-jpeg --with-opencl --with-boost
...
package() {
  ...
  # Install the Synfig Core documentation
  ...
  # Install the Synfig Core license
